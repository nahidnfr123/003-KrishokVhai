                                    ...
                                    <li class="col-md-3">
                                        ...
                                        <div class="carousel slide pt-1" id="carousel-example" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active"><img class="d-block w-100" src="/admin/app-assets/images/carousel/08.jpg" alt="First slide"></div>
                                                <div class="carousel-item"><img class="d-block w-100" src="/admin/app-assets/images/carousel/03.jpg" alt="Second slide"></div>
                                                <div class="carousel-item"><img class="d-block w-100" src="/admin/app-assets/images/carousel/01.jpg" alt="Third slide"></div>
                                            </div>
                                            <a class="carousel-control-prev" href="#carousel-example" role="button" data-slide="prev"><span class="la la-angle-left" aria-hidden="true"></span><span class="sr-only">Previous</span></a><a class="carousel-control-next" href="#carousel-example" role="button" data-slide="next"><span class="la la-angle-right icon-next" aria-hidden="true"></span><span class="sr-only">Next</span></a>
...
<!--                            <li class="nav-item dropdown navbar-search"><a class="nav-link dropdown-toggle hide" data-toggle="dropdown" href="#">
                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                <i class="fas fa-bell bell-shake" id="notification-navbar-link"></i>
                            ...
                            <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                    <div class="arrow_box_right">
                                        ...
                                        <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                                            <div class="media">
                                                <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="/admin/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"></span></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="/admin/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"></span></div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="/admin/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"></span></div>
                                                <div class="media-body">
                                        ...
                                        <li class="dropdown-menu-footer">
                                            <router-link class="dropdown-item text-right info pr-1"
                                                         :to="{name:'Chat'}">Read all
                                            </router-link>
                                        </li>
                                    </div>
                                </ul>
...
<!--                                            <img :src="user.avatar" alt="avatar" height="36" width="40"
                                        ...
                                        <a class="dropdown-item" href=""><i class="fas fa-tasks"></i> Task</a>
<!--                                        <a class="dropdown-item" href=""><i class="fas fa-comment"></i> Chats</a>-->
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item" href="#" @click.stop.prevent="logout()"><i class="fas fa-power-off"></i> Logout</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
...
export default {
    ...
    computed: {
        ...mapState('siteLayout', ['showNotification', 'showMessage']),
    },
    methods: {
        ...mapActions({
            logoutAction: 'auth/logout',
            toggleNotification: 'siteLayout/toggleNotification',
            toggleMessage: 'siteLayout/toggleMessage',
            closeNotification: 'siteLayout/closeNotification',
            closeMessage: 'siteLayout/closeMessage',
        }),
        clickToggleNotification() {
            this.toggleNotification();
            if (document.getElementById('MessageList').classList.contains('show')) {
                this.toggleMessage();
            }
        },
        clickToggleMessages() {
    ...
    created() {
        const escapeHandlerNotification = (e) => {
            e.stopPropagation();
            const element = document.getElementById('NotificationsList');
            if (element) {
                const inside = document.getElementById('NotificationsList').contains(e.target);
                if (!inside) this.closeNotification();
            }
        };
        document.addEventListener('click', escapeHandlerNotification);

        const escapeHandlerMessage = (e) => {
            e.stopPropagation();
            const element = document.getElementById('MessageList');
            if (element) {
                const inside = document.getElementById('MessageList').contains(e.target);
                if (!inside) this.closeMessage();
            }
        };
        document.addEventListener('click', escapeHandlerMessage);

        // Remove the event listeners ....
        this.$once('hook:destroyed', () => {
            document.removeEventListener('click', escapeHandlerNotification);
            document.removeEventListener('click', escapeHandlerMessage);
        });
    },
}
</script>
