            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title" id="horz-layout-colored-controls">Manage Product category</h4>
                    ...
                    <div class="card-content collpase show" v-if="user.status === 'active'">
                        <div class="card-body">
                            <div class="card-text">
                                <form method="post">
                                    <div class="row">
                                        <h3 class="text-muted">Add new product category</h3>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <Custom_Text_Input
                                                class="mb-2"
                                                type="text"
                                                label="Product category title slug"
                                                placeholder="Crop-health-and-nutrition"
                                                id="slug"
                                                name="slug"
                            ...
                            <div>
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="btn btn-sm btn-info" title="Refresh" @click.stop.prevent="getProductCategories()"><i class="fas fa-redo-alt"></i></button>
                                </div>
                                <hr>
                                <div v-if="Object.keys(productCategories).length">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            productCategoryErrors: 'productCategory/productCategoriesErrors',
            user: 'auth/user',
            userRole: 'auth/roles',
        })
    },
    ...
    methods: {
        ...mapActions({
            fetchProductCategory: 'productCategory/fetchProductCategory',
        ...
        async getProductCategories() {
            this.loading = true;
            await this.fetchProductCategory().then(() => {
                this.checkButtons();
            }).finally(() => {
                this.loading = false
            });
        ...
        async createCategory() {
            ...
            if (this.productCategoryErrors != null) {
                this.errors = this.productCategoryErrors;
                return
            }
            this.clearForm();
        },
        ...
        async deleteCategory(event) {
            this.$swal.fire({
                ...
                if (result.isConfirmed) {
                    this.deleteProductCategory(event.id).then(() => {
                        this.$swal.fire(
                            'Deleted!',
